                    ...
                    <form method="POST" action="{{ route('user.update',$user->id) }}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="code_apogée" type="number" class="form-control fs-4 @error('code_apogée') is-invalid @enderror" name="code_apogée" value="{{ $user->code_apogée }}" required autocomplete="code_apogée" autofocus placeholder="saisr votre code etudiant">
